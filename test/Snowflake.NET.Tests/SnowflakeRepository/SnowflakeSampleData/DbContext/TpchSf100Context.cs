...
using Snowflake.NET.Tests.SnowflakeRepository.SnowflakeSampleData.TpchSf100;

namespace Snowflake.NET.Tests.SnowflakeRepository.SnowflakeSampleData.DbContext;

/// <summary>
///		SF Schema Context class for the TpchSf100 schema.
/// </summary>
public class TpchSf100Context
{
	/// <summary>
